...
public class CollapsedStatusBarFragment extends Fragment implements CommandQueue.Callbacks,
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mLotusLogo = (ImageView)mStatusBar.findViewById(R.id.status_bar_logo);
        Dependency.get(DarkIconDispatcher.class).addDarkReceiver(mLotusLogo);
    ...
    public void onDestroyView() {
        ...
        Dependency.get(DarkIconDispatcher.class).removeDarkReceiver(mLotusLogo);
    }
    ...
    public void hideNotificationIconArea(boolean animate) {
        ...
        animateHide(mCenterClockLayout, animate, true);
        if (mShowLogo) {
            animateHide(mLotusLogo, animate, true);
        }
    }
    ...
    public void showNotificationIconArea(boolean animate) {
        ...
        animateShow(mCenterClockLayout, animate);
        if (mShowLogo) {
            animateShow(mLotusLogo, animate);
        }
    }
    ...
    public void updateSettings(boolean animate) {
        ...
        if (mNotificationIconAreaInner != null) {
            if (mShowLogo) {
                ...
                animateHide(mLotusLogo, animate, false);
            }
      }
    ...
    private void updateStatusBarLogo(boolean animate) {
        ...
        switch(mLogoStyle) {
            ...
            case 0:
                logo = getContext().getResources().getDrawable(R.drawable.ic_lotus_logo);
                break;
                // Khloe
            case 1:
        ...
        if (mLotusLogo != null) {
            if (logo == null) {
                ...
                mLotusLogo.setImageDrawable(logo);
                mShowLogo = false;
                return;
            }
